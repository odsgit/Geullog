  ...
  return (
    <div className="min-h-svh bg-gray-50">
      ...
      <main className="mx-auto flex w-full max-w-xl flex-col gap-6 px-6 py-12">
        <div>
          <h1 className="text-xl font-semibold text-gray-900">무료로 체험해보기</h1>
        ...
        {alreadyTried ? (
          <div className="rounded-2xl border border-gray-100 bg-white p-8 text-center shadow-sm">
            <p className="text-sm text-gray-600">이미 무료 체험을 사용하셨어요.</p>
            <Link
              to="/login"
              className="mt-4 inline-block rounded-lg bg-gray-900 px-4 py-2.5 text-sm font-medium text-white transition-colors hover:bg-gray-700"
            >
              가입하고 계속 쓰기
            </Link>
          </div>
      ...
      {showSignupModal && (
        <div className="fixed inset-0 flex items-center justify-center bg-gray-900/50 px-4">
          <div className="w-full max-w-sm rounded-2xl bg-white p-8 text-center shadow-lg">
            <h2 className="text-lg font-semibold text-gray-900">체험은 어떠셨나요?</h2>
            ...
            <div className="mt-6 flex flex-col gap-2">
              ...
              <button
                ...
                className="rounded-lg px-4 py-2.5 text-sm text-gray-500 hover:text-gray-700"
              >
                닫기
              </button>
            </div>
